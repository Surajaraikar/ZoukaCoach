...
export default function Home() {
  ...
  useEffect(() => {
    localStorage.setItem(
      "registeredSessions",
      JSON.stringify(registeredSessions)
    );
  }, [registeredSessions]);
  ...
  const getDurationInMinutes = useCallback(
    (durationString?: string): number => {
      ...
      const hourMatch = durationString.match(
        /(\d+(?:\.\d+)?)\s*(?:hour|hr|h)/i
      );
      if (hourMatch) {
  ...
  // Time to join window
  const isTimeToJoin = useCallback(
    (post: Post): boolean => {
  ...
  // Init EmailJS
  useEffect(() => {
    emailjs.init("CcHjd9UK5LIVBAK8X");
  }, []);
  ...
  const handleRegister = async (post: Post) => {
    ...
    try {
      await emailjs.send("service_wxg8iyr", "template_kr5fyrr", params);
  ...
  const tabs: TabItem[] = [
    ...
    { key: "games", label: "Mind Games (coming soon)" },
    ...
    <div className="flex flex-col min-h- bg-white xl:max-w-screen-2xl md:w-5/6 mx-auto px-5">
      ...
      <div className="lg:hidden my-4 ">
        ...
        <p className="text-[#535862] text-sm md:text-base">
          The heart of your brand. Captured, summarized, and ready to guide
          creation.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="flex-1 lg:pb-6 lg:pl-6 text-black w-full lg:w-auto lg:mt-2">
          ...
          <div className="mb-8 md:mb-12">
            <div className="lg:flex items-center justify-between mb-2 hidden">
              <div>
                ...
                <p className="text-[#535862] text-sm md:text-base">
                  The heart of your brand. Captured, summarized, and ready to
                  guide creation.
                </p>
              </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-8 bg-gradient-to-bl from-[#4D2E82] to-[#654D8E] p-4 md:p-6 rounded-xl mt-2 md:mt-10">
              ...
              <div className="w-full lg:w-2/3 space-y-2 md:space-y-4">
                ...
                <p className="text-white text-sm md:text-base">
                  Empower students and reduce institutional burdens through a
                  comprehensive placement management system. Ken42 believes in
                  an education system that inspires and paves pathways for
                  students to a future of possibilities.
                </p>
          ...
          <div className="mb-8 md:mb-12">
            {activeTab === "classes" && (
              <div>
                <h4 className="mb-4 text-lg md:text-xl font-medium">
                    ...
                    posts
                      .map((post, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="bg-[#EFEBF7] px-5 pt-5 pb-3 rounded-xl"
                          >
                            <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg border border-gray-200 flex flex-col">
                              ...
                              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-auto pt-3 border-t border-gray-100">
                                <div className="flex items-center gap-2">
                                  <Image
                                    src={"/images/dashBoard/vismaya.jpg"}
                                    alt={"instructor"}
                                    width={40}
                                    height={40}
                            ...
                            <div className="flex justify-end mt-3">
                              {post.Link && (
                                <button
                                  ...
                                  disabled={
                                    buttonProps.disabled || isSessionEnded(post)
                                  }
                                  className={`
            ...
            {activeTab === "games" && (
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Stay tuned for upcoming games content.
                </p>
              </div>
            )}
            ...
            {activeTab === "cohorts" && (
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  More details about cohorts will be available soon.
                </p>
              </div>
            )}
          </div>
