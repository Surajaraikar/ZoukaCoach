  ...
  return (
    <div>
      <div className="relative  h-screen bg-white overflow-hidden hidden sm:flex">
        ...
        <div className="absolute top-0 left-0 md:w-2/3 h-full z-10 sm:p-5 p-3">
          <video
            ...
            muted
            loop
            playsInline // ← tell React to render playsinline
            preload="auto"
            // for older Safari, you can also add the attribute via a ref:
            ref={(video) => {
              if (video) {
        ...
        <div className="absolute top-[5%] sm:top-[10%] left-[1%] z-10 p-6 text-white flex flex-col max-w-lg">
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold mb-2 sm:mt-4 mt-2 w-full">
            You're not lost. You just need a new perspective.
          </h2>
        ...
        <div className="absolute right-0 top-3/5 sm:right-2/12 sm:top-4/6 md:right-2/6 lg:right-1/6 md:top-4/6 lg:top-1/2 transform -translate-y-1/2 md:w-1/3 z-30 p-6">
          <SignUp
            appearance={{
              elements: {
      ...
      <div className="relative  h-screen bg-white overflow-hidden sm:hidden flex">
        ...
        {/* Clerk SignUp Component */}
        <div className="absolute top-1/12 -right-1 z-30 p-6">
          <SignUp
            appearance={{
              elements: {
                formButtonPrimary: "bg-[#4D2E82] hover:bg-[#3D2362] text-white",
