            ...
            <div className="">
                ...
                <div className="mb-10 md:mb-16">
                    ...
                    <h2 className="mt-2 sm:mt-4 text-black">
                        Your yesterday shaped today.<br className="hidden md:block" />
                        Your today is shaping tomorrow.
                    </h2>
                    <p className="mt-2 sm:mt-4 text-gray-700 max-w-4xl">
                        Most people wait for clarity to act. But clarity comes from <em>action</em>.<br className="hidden md:block" />
